...
import com.liaison.datastream.DatastreamProducer;
import com.liaison.registrar.types.DataCenterEnvironment;
...
public class NamedQueryConfiguration {
    ...
    public void setEnvironment(DataCenterEnvironment environment) {
        ...
        DatastreamProducer.initializeEnvironment(environment);
    }
